...
import net.tyler.yingyang.init.YingyangModProcedures;
...
public class YingyangMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger();
	public static final String MODID = "yingyang";
	...
	public void onInitialize() {
		...
		YingyangModItems.load();

		YingyangModProcedures.load();
