...
public class AbsoluteAltercationItem extends SwordItem {
	public AbsoluteAltercationItem() {
		super(new Tier() {
			public int getUses() {
				return 100;
			}
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		AbsoluteAltercationLivingEntityIsHitWithToolProcedure.execute(entity);
		return retval;
	}
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		AbsoluteAltercationRightclickedProcedure.execute(world, entity, ar.getObject());
		return ar;
	}
