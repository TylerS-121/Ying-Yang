...
import net.tyler.yingyang.item.CutMossItem;
import net.tyler.yingyang.item.ConfusedOreItem;
import net.tyler.yingyang.item.CleaveItem;
import net.tyler.yingyang.item.CharmSummonerItem;
import net.tyler.yingyang.item.BloomsCharmItem;
...
public class YingyangModItems {
	...
	public static Item BLOOMS_CHARM;
	public static Item CUT_MOSS;
	public static Item CLEAVE;
	...
	public static void load() {
		...
		BLOOMS_CHARM = register("blooms_charm", new BloomsCharmItem());
		CUT_MOSS = register("cut_moss", new CutMossItem());
		CLEAVE = register("cleave", new CleaveItem());
	}
